...
class _EditJobsState extends State<EditJobs> with TickerProviderStateMixin {
                              ...
                              children: <Widget>[
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Experience : " + active_job![index].experience,
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText1!
                                          .copyWith(
                                                      ...
                                                      RadioListTile<String>(
                                                        ...
                                                        onChanged: (val) {
                                                          stateSetter(() {
                                                            print(val);
                                                            _groupValue = val!;
                                                            job_status(FirebaseAuth.instance.currentUser!.uid.toString(), active_job![index].job_id);
                                                          });
                                                        },
                                                      ),
                                                      RadioListTile<String>(
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        Navigator.of(context).push(
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    edit_job_details(job_id:active_job![index].job_id)));
                                      },
                                      child: Column(
                                        children: <Widget>[
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                .size
                                                .width,
                                            child: Text(inactive_job![index].country,
                                                style: GoogleFonts.lato(
                                                    color: color.AppColor
                                                        .welcomeImageContainer,
                                                    fontSize: 18,
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                .size
                                                .width,
                                            child: Text(inactive_job![index].jobType,
                                                style: GoogleFonts.lato(
                                                    color: color.AppColor
                                                        .welcomeImageContainer,
                                                    fontSize: 18,
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                .size
                                                .width,
                                            child: Text(inactive_job![index].salary,
                                                style: GoogleFonts.lato(
                                                    color: color.AppColor
                                                        .welcomeImageContainer,
                                                    fontSize: 18,
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                ...
                                                .width,
                                            child: Text(
                                                inactive_job![index].description,
                                                // overflow:
  ...
  Future<String?> get_jobs() async
  {
    ...
    try
    {
      firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).collection("job_opening").get().then((value)
      {
        for(int i=0; i<value.docs.length; i++)
        {
          try
          {
            firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).collection("job_opening").doc(value.docs[i].id.toString()).get().then((value){
              ...
              if(h != null)
              {
                ...
                developer.log("my data g       "+ h.toString()+"    "+ _jobsearchresponse!.jobStatus);
              }
            }).whenComplete(()
            {
  ...
  /// candidate status ////////////////////////////////////////////////////////
  Future<String?> job_status(String company_id, String job_id, ) async
  { print(company_id +"       "+ job_id);
    try
    {
      firestoreInstance.collection("users").doc(company_id).collection("job_opening").doc(job_id).update(
          {

            "job_status": _groupValue
              ...
              try
              {
                firestoreInstance.collection("jobs").doc(value.docs[i].id.toString()).get().then((value){
                  ...
                  if(h != null)
                  {
                    ...
                    {
                      firestoreInstance.collection("jobs").doc(current_doc).update(
                          {
