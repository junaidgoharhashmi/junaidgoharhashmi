...
class CandidateDetailScreen extends StatefulWidget {
  ...
  CandidateDetailScreen({Key? key, required this.username, required this.experience,required this.skill,required this.high_edu,required this.contact,required this.candidates_status,required this.email,required this.job_id,required this.company_id,required this.user_id}) : super(key: key);
...
class _CandidateDetailScreenState extends State<CandidateDetailScreen> {
  ...
  Future<String?> candidate_status() async
  {
    try
    {
      firestoreInstance.collection("users").doc(widget.user_id).collection("Applied_Jobs").doc(widget.job_id).update(
          {
      ...
      {
        firestoreInstance.collection("users").doc(widget.company_id).collection("Applied_user").doc(widget.job_id).update(
            {
              "candidate_status":_candidateStatus,
            }
        ).then((values){
  ...
  get_candidate_status() async
  {
    ...
    try
    {
      firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).collection("Applied_user").doc(widget.job_id).get().then((value){
