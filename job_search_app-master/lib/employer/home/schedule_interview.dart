...
class ScheduleInterviewScreen extends StatefulWidget {
  ...
  const ScheduleInterviewScreen({Key? key,required this.candidate,required this.jobTitles,required this.job_id,required this.user_id,required this.company_id}) : super(key: key);
...
class _ScheduleInterviewScreenState extends State<ScheduleInterviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: customAppBarEmployer(context, 'Schedule Interviews'),
  ...
  Future<String?> schedule_interview() async
  {
    try
    {
        firestoreInstance.collection("users").doc(widget.company_id).collection("scheduled_interview").add(
            {
          ...
          final Email email = Email(
            body: "you have shortlisted for interview. \nDate and Time:$startdateTime " + " -  $endDateTime" ,
