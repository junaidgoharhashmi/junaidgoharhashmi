...
class _edit_job_details extends State<edit_job_details> {
  ...
  Future<String?> update_job() async
  {
    try
    {
      ...
      firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).collection("job_opening").doc(widget.job_id).update(
          {
  ...
  Future<String?> get_job() async
  {
    try
    {
      firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).collection("job_opening").doc(widget.job_id).get().then((value){
        Map<String,dynamic>? h = value.data();
