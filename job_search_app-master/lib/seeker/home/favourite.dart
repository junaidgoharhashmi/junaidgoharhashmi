                          ...
                          GestureDetector(
                            onTap: ()
                            {
                              Navigator.push(context,
                                  PageTransition(
                                      child: ApplyJob(id: result['job_id'], company: result['company_name'],company_id: "",job_id: result['job_id'],user_name:user!.displayName.toString(),contact_number: user!.phoneNumber.toString()), type: PageTransitionType.fade));
                            },
                            child: card(
