...
class _EditProfileState extends State<EditProfile> {
  ...
  String profileImg = "https://thumbs.dreamstime.com/b/default-avatar-profile-icon-vector-unknown-social-media-user-photo-default-avatar-profile-icon-vector-unknown-social-media-user-184816085.jpg";
  String resumefile = "";
            ...
            return ListView(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text(resumefile+ "my file",style: GoogleFonts.lato(
                      color: color.AppColor.welcomeImageContainer,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customProfileAppBar(
          context, 'Edit Profile', CupertinoIcons.moon_stars),
      body: Center(
  ...
  Future uploadFile(File image) async {
    try
    {
      firebase_storage.Reference ref = firebase_storage.FirebaseStorage.instance
          .ref()
          .child("profile/${FirebaseAuth.instance.currentUser!.uid}/Profile_Img");
      ...
      uploadTask.whenComplete((){
        ...
        ref.getDownloadURL().then((fileURL) {
          ...
          firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).
          update({"photoURL":fileURL.toString()}).
          whenComplete((){
            setState(() {
              profile_img = true;
    ...
    try
    {
      ...
      uploadTask.whenComplete((){
        ...
        ref.getDownloadURL().then((fileURL) {
          ...
          firestoreInstance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).
          update({"resume":fileURL.toString()}).
          whenComplete((){
            setState(() {
              resume_bol = true;
